...
class UpgradePage2:
    def __init__(self, parent_screen, username, total_score, health,life, original_damage, original_speed, original_health):
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        if event.ui_element == quit_button:
                            ...
                            game_manager.show_level3_page(self.username, self.total_score, self.health, self.life, self.disabled_button,self.original_damage, self.original_speed, self.original_health)
...
if __name__ == "__main__":
    ...
    upgrade_page = UpgradePage2(screen)
    upgrade_page.run()