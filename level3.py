...
class Level3:
    def __init__(self, username, total_score, health, life, upgrade, damage_lvl2, speed_lvl2, health_lvl2):
        pygame.init()
        pygame.mixer.init()
        # SPRITE GROUPS
        ...
        self.damage_lvl2 = damage_lvl2
        self.speed_lvl2 = speed_lvl2
        self.health_lvl2 = health_lvl2
        ...
        self.level2 = self.font.render("LEVEL 3", 1, (0, 0, 0))
        # IMAGES
